...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_config_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__prod_config_js__ = __webpack_require__(25);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_node_gitlab_api__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_js_base64__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__database_js__ = __webpack_require__(9);
...
module.exports = {
	...
	plugins: [{ src: "~/plugins/element-ui", ssr: false }, { src: "~/plugins/codemirror", ssr: false }, { src: "~/plugins/persistedstate", ssr: false }, { src: "~/plugins/app", ssr: false }, { src: "~/plugins/test", ssr: false }],
	/*
 ** Headers of the page
 */
	head: {
 ...
 */
  ...
  */
	build: {
		vendor: ["vue-template-compiler", "vuex-persistedstate", "axios", "lodash", "element-ui", "elasticsearch", "jshashes", "js-base64", "js-cookie", "jss", "jss-preset-default", "node-gitlab-api", "codemirror", "vue-codemirror"],
		/*
  	  	 ** Run ESLINT on save
  	  	 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__koa_cors__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_koa_jwt__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_koa_session__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_koa_router__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_koa_body__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__config_js__ = __webpack_require__(1);
...
var apiRouter = new __WEBPACK_IMPORTED_MODULE_4_koa_router___default.a({
...
/* harmony default export */ exports["a"] = function (app, views) {
	var viewRouter = new __WEBPACK_IMPORTED_MODULE_4_koa_router___default.a({});
	//viewRouter.get("/www/*", views);

	app.use(__WEBPACK_IMPORTED_MODULE_1__koa_cors___default()()).use(__WEBPACK_IMPORTED_MODULE_5_koa_body___default()()).use(__WEBPACK_IMPORTED_MODULE_2_koa_jwt___default()({ secret: __WEBPACK_IMPORTED_MODULE_9__config_js__["a" /* default */].secret, passthrough: true, cookie: "token" })).use(__WEBPACK_IMPORTED_MODULE_3_koa_session___default()({ signed: false }, app)).use(apiRouter.routes()).use(apiRouter.allowedMethods()).use(viewRouter.routes());
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_elasticsearch__ = __webpack_require__(27);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_dataSource_js__ = __webpack_require__(8);
...
DataSource.prototype.getDefaultDataSource = function () {
	var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.mark(function _callee(ctx) {
		var params, authUsername, username, dataSource;
		return __WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
			while (1) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_js_yaml__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common_error_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__config_js__ = __webpack_require__(1);
...
var getGitData = function () {
	var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.mark(function _callee(git, path) {
		var content, data;
		return __WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
			while (1) {
				switch (_context.prev = _context.next) {
...
Gitlab.prototype.submitESData = function () {
	var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.mark(function _callee2(item) {
		var data, tablename, path, action, indexs, esData, res;
		return __WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
			while (1) {
...
Gitlab.prototype.webhook = function () {
	var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.mark(function _callee3(ctx) {
		var self, params, commit, project_url, origin, gitcfg, git, filelist, dataFileReg, filelistAddItem, promises;
		return __WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
			while (1) {
...
Gitlab.prototype.gitlab = function () {
	var _ref4 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.mark(function _callee4(ctx) {
		var params, gitcfg, git;
		return __WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee4$(_context4) {
			while (1) {
		...
		__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.each(ctrl.getRoutes(), function (route) {
			...
			__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.each(methods, function (method) {
				...
				router[method](route.path, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__middlewares_index_js__["a" /* validate */])(route.validate), function () {
					var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.mark(function _callee(ctx, next) {
						var body;
						return __WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
							while (1) {
								switch (_context.prev = _context.next) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common_error_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_user_js__ = __webpack_require__(10);
...
User.prototype.login = function () {
	var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.mark(function _callee2(ctx) {
		var params, user;
		return __WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
			while (1) {
				switch (_context2.prev = _context2.next) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__user_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dataSource_js__ = __webpack_require__(8);
/* unused harmony export User */
/* unused harmony export DataSource */
...
var start = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.mark(function _callee2() {
    var _this = this;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            app.use(function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.mark(function _callee(ctx, next) {
                return __WEBPACK_IMPORTED_MODULE_0__mnt_d_workspace_lua_keepwork_kp_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
